...
const Services = () => {
  return (
    <div className="mt-[85px]">
      ...
      <div className="grid grid-cols-2 px-[40px] md:grid-cols-3 3xl:mx-[150px]  mb-[100px]">
        ...
        <div className="mx-[50%] drop-shadow-2xl shadow-[3px_3px_16px_rgba(0,0,0,0.25)] relative rounded-[5px] mt-[40px] md:mt-[100px] w-[140px] md:w-[353px] md:h-[525px]  h-[200px] justify-center bg-white   border-[0.4px]  ">
          <Lottie
            className=" absolute w-[100px] md:w-[340px] bottom-[150px] right-[20px] md:bottom-[360px] md:right-[20px]"
            animationData={animationData}
          />
