  ...
  return (
    ...
    <div className="mt-[35px]  relative flex  items-start text-2xl w-fit max-md:max-w-full min-h-screen">
      ...
      />
       ...
       <h1 className="font-['Encode_Sans_Semi_Expanded'] text-[70px] px-[150px] self-stretch text-white">Welcome</h1>
       <div className="flex flex-row relative">
          <h1 className="font-['Encode_Sans_Semi_Expanded'] px-[150px] text-[20px] pt-[35px] text-white">Don't have an account? </h1>
          ...
          <div className="mt-[60px]">
            <h1 className="pl-[90px] text-white text-[20px]"
            >Username</h1>
            <input
          type="usn"
          ...
          <h3
          className="text-white text-[20px] pl-[100px] underline"> Forgot Password?</h3>
