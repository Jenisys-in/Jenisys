...
function Contact() {
  ...
  return (
    <div className="flex overflow-hidden flex-col items-center px-20  bg-white max-md:px-5  mt-[85px] md:mt-0">
      ...
      <div className="scroll-on-appear font-['Montserrat']  mt-20  text-4xl font-bold tracking-tighter leading-tight text-black max-md:mt-10 max-md:max-w-full px-[40px] md:px-0">
        ...
        <div className="flex gap-5 max-md:flex-col">
          <div className="flex flex-col w-[41%] max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow items-center leading-tight text-black max-md:mt-10">
              ...
              <div className="font-['Montserrat']  self-stretch mt-6 ml-[60px] text-xl tracking-tight">
            ...
            <div className="flex flex-col mt-28 w-full leading-tight text-black max-md:mt-10 max-md:max-w-full">
              ...
              <div className="md:flex md:flex-row flex-col gap-5 items-start md:mt-20 max-md:mt-3 max-md:mr-0.5 max-md:max-w-full">
                <div className="flex flex-col flex-1 grow shrink-0 basis-0 w-fit">
                  ...
                  <input
                    className="md:w-[267px] md:mt-[10px]  md:h-[48px] w-[376px] h-[40px] shadow-[0px_0px_8px_rgba(0,0,0,0.25)] border-[rgba(0,0,0,0.25)] border-[0.5px] font-light font-['Montserrat']  top-[14px] left-[13px] tracking-[-0.02em] leading-[120%] text-black text-left inline-block h-5 p-0 z-[1]"
                ...
                <div className="flex flex-col flex-1 grow shrink-0 basis-0 w-fit">
                  ...
                  <input
                    className="md:w-[267px] font-['Montserrat']  md:mt-[10px] md:h-[48px] w-[376px] h-[40px] shadow-[0px_0px_8px_rgba(0,0,0,0.25)] border-[rgba(0,0,0,0.25)] border-[0.5px] font-light   top-[14px] left-[13px] tracking-[-0.02em] leading-[120%] text-black text-left inline-block h-5 p-0 z-[2]"
              ...
              <input
                ...
                type="text"
              />
              <button className="font-['Montserrat']  px-16 py-8 mt-14 text-2xl font-semibold tracking-tight text-white bg-indigo-800 rounded-md max-md:px-5 max-md:mt-10 max-md:mr-0.5 max-md:max-w-full">
                Get Started
              </button>
            </div>
          </div>
