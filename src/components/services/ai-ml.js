            ...
            <div className="lg:col-span-1">
              <div className="mb-6">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-white">Jenisys</h3>
                </div>
                <h4 className="text-xl font-bold text-white mb-3">
                  Advancing Excellence Beyond Cost
                </h4>
                <p className="text-gray-300 text-sm leading-relaxed">
                  Delivering innovative AI solutions that drive business growth
                  and operational excellence through cutting-edge technology and
              ...
              <button
                onClick={() => scrollToSection("cta")}
                className="group bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center gap-2"
              >
                Get Started Today
                ...
                {[
                  ...
                  <li key={link.name}>
                    <button
                      ...
                      className="text-gray-300 hover:text-white transition-colors duration-200 flex items-center gap-2 group text-left"
                    >
                      {link.name}
