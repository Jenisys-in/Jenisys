...
const servicesData = [
  ...
  },
  {
    ...
    description:
      "Streamline your development & operations with our DevOps services. We implement continuous integration and continuous deployment (CI/CD) pipelines to automate and accelerate your software development process. Our team uses infrastructure as code (IaC) to ensure consistency and scalability in your IT infrastructure. By integrating development and operations, we help you achieve faster delivery times & improved quality. Trust Jenisys to help you environment that supports your business goals.",
    icon: "/img/laptop.png",
...
const generateStructuredData = () => {
  const organization = {
    ...
    name: "Jenisys",
    description:
      "Leading tech solutions provider crafting top-tier software and digital solutions for businesses of all sizes",
  ...
  return {
    ...
    description:
      "Comprehensive technology services including custom software development, web & mobile apps, IT consulting, cybersecurity, DevOps, and digital transformation solutions.",
...
const ServiceCard = ({ service, animationData, index }) => {
  ...
  return (
    <article
      className={`scroll-on-appear drop-shadow-2xl shadow-[3px_3px_16px_rgba(0,0,0,0.25)] relative rounded-[5px] mt-[40px] md:mt-[100px] w-[140px] md:w-[353px] md:h-[525px] h-[200px] justify-center bg-white border-[0.4px] ${
        isLastCard ? "mx-[50%] md:mx-0" : ""
      }`}
      itemScope
    ...
    >
      ...
      <div
        className="bg-[#8847FA] absolute h-[34px] w-[34px] md:h-[114px] md:w-[114px] rounded-full bottom-[182px] md:bottom-[472px] right-[53px] md:right-[133px] z-10"
        aria-hidden="true"
      />
      ...
      {/* CTA Button */}
      <button
        className={`rounded-[1px] w-[55px] md:w-[147px] md:h-[49px] md:rounded-[4px] text-[8px] h-[15px] mx-[40px] md:mx-[100px] bg-[#8847FA] text-white font-['Montserrat'] font-semibold md:text-[20px] hover:bg-[#7038E0] transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-[#8847FA] focus:ring-opacity-50 ${
          service.title === "Emerging Technologies" ? "md:mt-[50px]" : ""
        }`}
        type="button"
...
const Services = () => {
  ...
  return (
    <>
      ...
      <Head>
        <title>
          Jenisys Services - Custom Software Development & IT Solutions | Expert
          Technology Services
        </title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Jenisys Services - Custom Software Development & IT Solutions"
        />
        <meta
          property="og:description"
          content="Transform your business with our comprehensive technology services including custom software development, web & mobile apps, IT consulting, and cybersecurity solutions."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://jenisys.com/services" />
        <meta
          property="og:image"
          content="https://jenisys.com/img/services-og-image.jpg"
        />
        ...
        <meta
          name="twitter:image"
          content="https://jenisys.com/img/services-twitter-image.jpg"
        />
      ...
      <main className="mt-[85px] w-full overflow-x-hidden">
        {/* Hero Section */}
        <section
          className="scroll-on-appear w-full"
        ...
        >
          ...
          <div className="w-full mt-[20px] overflow-hidden">
            ...
            >
              ...
              <track
                kind="captions"
                src="/captions/services-video.vtt"
                srcLang="en"
                label="English"
              />
              <p>
                Your browser does not support the video tag.{" "}
                <a href="/Our Services Video.mp4">Download the video</a> to
